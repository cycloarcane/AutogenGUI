...
input_text = tk.Text(input_frame, height=4, width=40, bg="black", fg="green", highlightbackground="green", highlightcolor="green", highlightthickness=1, insertbackground="green", wrap=tk.WORD)
...
start_button = tk.Button(input_frame, text="Start", command=handle_request, fg="green", bg="black")
